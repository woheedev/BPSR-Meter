...
export interface SeasonTargetInfo {
  targetId: number;
  targetProgress: number;
  awardState: number;
}

function createBaseSeasonTargetInfo(): SeasonTargetInfo {
  return { targetId: 0, targetProgress: 0, awardState: 0 };
}

export const SeasonTargetInfo: MessageFns<SeasonTargetInfo> = {
  encode(message: SeasonTargetInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SeasonTargetInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSeasonTargetInfo();
  ...
  fromJSON(object: any): SeasonTargetInfo {
    return {
  ...
  toJSON(message: SeasonTargetInfo): unknown {
    const obj: any = {};
    if (message.targetId !== 0) {
  ...
  create<I extends Exact<DeepPartial<SeasonTargetInfo>, I>>(base?: I): SeasonTargetInfo {
    return SeasonTargetInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SeasonTargetInfo>, I>>(object: I): SeasonTargetInfo {
    const message = createBaseSeasonTargetInfo();
