            ...
            <div style={{ position: "relative", width: "100%" }}>
                <input
                    ...
                    style={{
                        width: "100%",
                        cursor: "pointer",
                        backgroundColor: isRecording ? "rgba(59, 130, 246, 0.2)" : "var(--bg-dark)",
                        border: isRecording ? "2px solid rgba(59, 130, 246, 0.5)" : "1px solid rgba(255, 255, 255, 0.1)",
                        padding: "8px 40px 8px 12px",
                        fontSize: "13px",
                        fontFamily: "monospace",
                        color: isRecording ? "rgba(59, 130, 246, 1)" : "var(--text-primary)",
                        textAlign: "center",
